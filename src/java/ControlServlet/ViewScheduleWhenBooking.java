 ...
 */
public class ViewScheduleWhenBooking extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("minDate", minDate);
          if (fromDate.isEmpty() || content.isEmpty()) {
              request.setAttribute("msg", "Please choose Date and Disease to viewSchedule");
//            request.setAttribute("scheduleList", sdao.getAllSchedule());
        } else {
            request.setAttribute("scheduleList", sdao.getScheduleNotBooked(content, fromDate));
        }
